...
var awardsData = [
  ...
  {id: 2,   store: 3,  validity: 1445558400,  title: "50% na segunda compra", description: "50% a partir do segundo artigo comprado"},
...
var brandsData =[
  {id: 1, name: "Vitaminas",            categorie: 1, checkins: 1,  image: "assets/1000345.jpg",                         description: "O nosso menu oferece-lhe os alimentos mais saudáveis que pode encontrar num restaurante: vegetais, fruta, queijos, massas, carnes brancas, peixes e cereais de excelente qualidade. E na forma mais simples e rápida de satisfazer o seu prazer: saladas, sandes e sumos. Esperamos por si, sabemos que vai voltar."},
  {id: 2, name: "Pizza Hut",            categorie: 1, checkins: 10, image: "assets/pizza-hut.jpg",                       description: "Em 1958, o conceito de pizzaria era ainda relativamente novo para a maioria dos americanos. Frank e Dan Carney, então estudantes universitários, aceitaram o desafio de um amigo da família e iniciaram a Pizza Hut com um pequeno empréstimo de 600 dólares cortesia da mãe."},
  {id: 3, name: "H3 Hamburger Gourmet", categorie: 1, checkins: 8,  image: "assets/p2_h3_s.jpg",                         description: "Porque o calor começa a apertar, lançámos um novo hambúrguer com espinafres frescos, molho de iogurte e hortelã, tomate e cebola roxa. Não deixe de provar antes que acabe, porque o h3 Verão é uma edição limitada."},
  {id: 4, name: "Perfumes & Companhia", categorie: 3, checkins: 5,  image: "assets/logo_perfumes.jpg",                   description: "The P&C – Perfumes & Companhia, SA is currently the largest chain of Selective Perfumeries in Portugal, having asserted itself in the Portuguese market as the most dynamic and complete reference in this sector. It is a 100% Portuguese family company, in the market since 1981."},
  {id: 5, name: "Berska",               categorie: 2, checkins: 8,  image: "assets/bershka-logo.jpg",                    description: "Bershka é uma companhia de lojas de roupas que pertence ao grupo Inditex, ao qual pertence também a Zara. Esta companhia foi criada em Abril de 1998 com o objectivo de cativar o mercado jovem e juvenil."},
  {id: 6, name: "KIKO",                 categorie: 3, checkins: 15, image: "assets/transferir.png",                      description: "KIKO MILANO, marca italiana de cosméticos de maquilhagem e de cuidados para a pele. Produtos de beleza e tratamentos para o rosto e para o corpo de elevada qualidade, seguros e eficazes, criados para satisfazer os desejos de beleza das mulheres de todas as idades."},
  {id: 7, name: "Gardénia",             categorie: 5, checkins: 3,  image: "assets/logo.png",                            description: "As Lojas GARDENIA são um ícone da moda em Lisboa, desde 1988. Cada uma das suas lojas é um espaço único, com identidade própria, combinando o clássico com o moderno, o glamour com o urbano casual. O atendimento, sendo muito cordial e personalizado, cada cliente é tratado como especial e único. A loja mais antiga é um local a não perder, Casa centenária, classificada como património arquitectónico, da autoria do arquitecto Raúl Lino – 1917, no Chiado – Rua Garrett, 54. Recheada com marcas de referência como XUZ, DNKY, HUNTER, UGG, FLY LONDON, DKODE, DYSFUNCTIONAL, SAHOCO, GUESS, CUBANAS, PARIS HILTON, ELEVEN PARIS, LEMON JELLY entre outras."},
  {id: 8, name: "Starbucks",            categorie: 1, checkins: 8,  image: "assets/Starbucks.png",                       description: "Starbucks Corporation, doing business as Starbucks Coffee, is an American coffee company and coffeehouse chain based in Seattle, Washington. Starbucks is the largest coffeehouse company in the world, with 22,766 stores in 65 countries and territories, including 12,802 in the United States, 1,930 in China, 1,409 in Canada, 1,121 in Japan and 825 in the United Kingdom."},
  {id: 9, name: "Pinkie",               categorie: 2, checkins: 4,  image: "assets/pimkie-logo.jpg",                     description: "Marca francesa de vestuário e acessórios de mulher. As lojas Pimkie em Portugal estão localizadas em centros comerciais."},
  {id: 10, name: "Mr. Blue",            categorie: 2, checkins: 8,  image: "assets/mr_blue_porto_airport_may2011_1.jpg", description: "A Mr. Blue é uma marca europeia para quem gosta de viver com estilo. A roupa tem um design intemporal, tecidos cuidadosamente escolhidos, confecionados com elevada qualidade e com preços acessíveis. Na Mr. Blue encontra uma enorme variedade de produtos para as mais variadas ocasiões, um fim-de-semana em familia, uma importante reunião de negócios, uma festa de empresa ou para um jantar descontraido entre amigos. "},
  {id: 11, name: "Primark",             categorie: 2, checkins: 1,  image: "assets/primark-emprego.jpeg",                description: "Adorada pelos fãs da moda e por quem procura valor, a Primark está fortemente estabelecida como a loja de opção para quem pretende acompanhar as tendências mais atuais de forma acessível."}
];
